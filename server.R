...
#load("C:\\Users\\jgaleano\\Dropbox\\R\\SHINY\\NEW_DP\\population_change\\data\\COUNTRYBIRTH.Rdata")
  ...
  observe({
    updateSelectizeInput(session, 'MUNICIPALITY', 
                         ...
                         selected= ifelse(input$prov=="Basque Country", "Bilbao",
                                   ...
                                   ifelse(input$prov=="Extremadura", "CÃ¡ceres",
                                   ...
                                   ifelse(input$prov=="La Rioja", "LogroÃ±o",
                                   ifelse(input$prov=="Madrid", "Madrid",
                                   ifelse(input$prov=="Murcia", "Murcia",
                                   ifelse(input$prov=="Navarra", "Pamplona/IruÃ±a",
                                   ifelse(input$prov=="Asturies", "GijÃ³n",
  ...
  output$pyramidrel <- renderHighchart({
    ...
    highchart() %>%
      ...
      hc_tooltip(shared = FALSE,
                 formatter = JS("function () { return '<b>' + this.series.name + '<br>' +'Edad: ' + this.point.category + '</b><br/>' + 'PoblaciÃ³n: ' + Math.abs(this.point.y);}"))
