                        ...
                        mainPanel( 
                          tabsetPanel(
                            tabPanel(h6("Simpson's Diversity Index"),
                                     br(),
                                     highchartOutput("ComposicionPlot9",width = '100%', height = 600)),
                            tabPanel(h6('Entropy Index'),
                                     br(),
                                     highchartOutput("entropy",width = '100%', height =600)),
  ...
  tabPanel(h5(span("About the project")), 
           mainPanel(
             ...
             p("This application has been developed using the web application framework , ", a("Shiny", href="http://shiny.rstudio.com/"), "for ", 
               a("the R language", href="https://www.r-project.org/"),". For designing of the interface we use the package ",
               ...
               a("ggmap",href="https://cran.r-project.org/web/packages/ggmap/index.html")," y ", 
               ...
               a("maptopls", href="https://cran.r-project.org/web/packages/maptools/index.html"),", ",
